package com.taeho.myfavorite.global.security.configure;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.taeho.myfavorite.global.security.JwtUtil;
import com.taeho.myfavorite.global.security.filter.AuthorizationFilter;
...
public class WebSecurityConfigure {
    ...
    public AuthorizationFilter authenticationFilter() {
        return new AuthorizationFilter(jwtUtil, userDetailsImplService, objectMapper);
    }
